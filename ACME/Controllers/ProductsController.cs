    ...
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProductId,Name,Price")] Product product)
        {
            ...
            */
            ...
            product.ProductId = Guid.NewGuid();
            product.Name = Request["Name"]; // weakly-typed, magic strings
            product.Price = Decimal.Parse(Request["Price"]); // weakly-typed, magic strings
            */

            /*
            var product = new Product();
            product.ProductId = Guid.NewGuid();
            product.Name = Name; // strongly-typed
            product.Price = Price; // strongly-typed
            */
